...
const EventList = () => {
  ...
  return (
    <div>
      ...
      <Link to="/events/create"><button className="bg-blue-500 hover:bg-blue-400 text-white font-bold py-2 px-4 border-b-4 border-blue-700 hover:border-blue-500 rounded">Create Event</button></Link>
    </div>
  );
};
...
//                 {event.title} - {event.location}
//               </Link>
//               {/* Optional: Add event details or image */}
//             </li>
//           ))}
//         </ul>
//       </div>
